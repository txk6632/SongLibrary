    ...
    public class SongRepository
    {
        ...
        public DataTable GetAll()
        {
            var dt = new DataTable()
            {
                Columns =
                {
                    new DataColumn(ColumnNames.Id, typeof(int)),
                    new DataColumn(ColumnNames.Title, typeof(string)),
                    new DataColumn(ColumnNames.Artist, typeof(string)),
                    new DataColumn("release_date", typeof(string)),//SQLite stores dates as text
                    new DataColumn(ColumnNames.Price, typeof(decimal))
                }
            };
